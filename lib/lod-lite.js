...
const end = () => {
  ...
  logger.info('Extracted files : %s', infos.files)
  logger.info('Fails : %s', infos.fail.length, infos.fail.join(','))
  logger.exit()
}
...
const main = async () => {
  ...
  resource(args.resource, begin, end)
}

main()

module.exports = { begin, end, main }
